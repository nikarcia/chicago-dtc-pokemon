...
public class GetPokemonResponse {
    ...
    protected List<GetPokemonResponse.Pokemon> pokemon;
     ...
     * {@link GetPokemonResponse.Pokemon }
     * 
     * 
     */
    public List<GetPokemonResponse.Pokemon> getPokemon() {
        if (pokemon == null) {
            pokemon = new ArrayList<GetPokemonResponse.Pokemon>();
        }
        return this.pokemon;
    }
